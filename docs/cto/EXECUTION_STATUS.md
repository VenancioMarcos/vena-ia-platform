...
```text
MISSION=TASK_V14_003
STATE=VENA_IA_V1_4_PACKAGE_3_READY_FOR_CTO_REVIEW
BRANCH=codex/v1.4-observability-auditability
START_HEAD=dff254255ab9bf586ada3490c09aab9623d2ff70
...
NEXT=CTO_REVIEW_AFTER_FINAL_CI
```
