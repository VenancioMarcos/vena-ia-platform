...
| R-034 | MÉDIO | Não há deploy, capacidade produtiva ou escalabilidade validados. | Perfil sintético reproduzível mede guardrails/gargalos pequenos; piloto/deploy e topologia real continuam obrigatórios. | MITIGADO PARCIALMENTE v1.6 PACKAGE 3 / MONITORAR |
