...
| R-019 | ALTO | Envelope calculado por pontos STEP pode divergir da bounding box topológica e volume não é confiável sem kernel geométrico. | ADR-0015 seleciona OpenCascade com restrições; contrato retorna NOT_AVAILABLE até validação binária, topológica e de corpus. | MITIGADO PARCIALMENTE v1.8 PACKAGE 1 / MONITORAR |
