...
| R-042 | CRÍTICO | Uma futura fronteira Organization/Team pode permitir escalada de papel ou acesso cruzado entre organizações/equipes. | Package 1 proposto exige identidade apenas do token/banco, membership allowlisted, menor privilégio, ownership centralizado, cross-organization/team 404, mass-assignment negativo e auditoria. Nenhum código foi implementado nesta decisão. | ABERTO / GATE v1.9 PACKAGE 1 |
