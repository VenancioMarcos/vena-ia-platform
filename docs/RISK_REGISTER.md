...
| R-031 | ALTO | PostgreSQL e MinIO não possuíam recuperação verificável. | Packages 1–2 adicionam contratos, checksums, restore descartável combinado e detecção de inconsistência; automação, criptografia gerenciada, retenção e medição operacional permanecem pendentes. | MITIGADO PARCIALMENTE v1.3 PACKAGE 2 / BLOQUEIA PILOTO |
