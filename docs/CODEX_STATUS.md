...
```text
STATE=V2_1_PACKAGE_1_LOCAL_VALIDATED_PENDING_CI
MISSION=TASK_V21_001
BRANCH=codex/v2.1-enterprise-engineering-governance
...
LOCAL=RUFF_MYPY_168_API_355_PASS_2_SKIP_OPERATIONS_69_PASS_7_SKIP_COMPOSE_OPENAPI_PASS
LOCAL_POSTGRESQL_MIGRATION=DEFERRED_DOCKER_DAEMON_ABSENT_BACKEND_CI_REQUIRED
```

```text
STATE=V2_1_PACKAGE_2_LOCAL_VALIDATED_PENDING_CI
MISSION=TASK_V21_002
PR=25_OPEN_DRAFT
MIGRATION_HEAD=e61c4f8a2b90_UNCHANGED
V2_1=FUNCTIONALLY_COMPLETE_RELEASE_CANDIDATE_PENDING_CTO_REVIEW
V2_2=NOT_STARTED
V3_0=NOT_STARTED
LOCAL=RUFF_MYPY_168_API_357_PASS_2_SKIP_ENGINEERING_18_PASS_OPERATIONS_69_PASS_7_SKIP_OPENAPI_79_COMPOSE_PASS
```
