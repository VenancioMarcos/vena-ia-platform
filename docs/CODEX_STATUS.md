...
```text
STATE=V2_1_RELEASE_CANDIDATE_VALIDATION_IN_PROGRESS
MISSION=TASK_V21_003
...
RELEASE=NOT_PUBLISHED_OWNER_GATE_REQUIRED
...
FRONTEND_LOCAL=DEFERRED_RUNTIME_MISMATCH_NODE_24_PNPM_11_16_OFFICIAL_CI_NODE_22_20_PNPM_11_9_REQUIRED
POSTGRESQL_CYCLE=BACKEND_CI_REQUIRED
```
