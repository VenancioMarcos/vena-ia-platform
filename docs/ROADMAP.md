...
**Package 2 — Governance evidence — `IMPLEMENTED / READY_FOR_CTO_REVIEW`:** autorização fail-closed, auditoria de lifecycle,
...
massa. A v2.1 está `FUNCTIONALLY_COMPLETE / RELEASE_CANDIDATE_PENDING_CTO_REVIEW`;
nenhuma Release, v2.2 ou v3.0 foi iniciada.
