...
**Data:** 2026-08-01
**Estado:** MVP publicado e pacotes 1, 2 e 3 da v1.1 validados na Draft PR #11
...
| Dashboard/projetos | SQLAlchemy + ownership | `/projects` | `/dashboard` | projects + E2E | Criação atualiza a lista sem refazer sessão/listagem |
| Upload PDF | assinatura, MIME, tamanho, MinIO | `/projects/{id}/documents` | detalhe do projeto | documents + E2E | Resposta atualiza somente documentos |
