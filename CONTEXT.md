...
* **Security Gate 2026-07-30:** riscos críticos R-001 a R-004 mitigados e revisão final validada no branch `security/v0.4.1-authentication-authorization`, já enviado ao `origin`. A matriz oficial está em `docs/AUTHORIZATION_MATRIX.md`; decisão em `docs/adr/ADR-0009-security-gate-authentication.md`. A Draft PR [#4](https://github.com/VenancioMarcos/vena-ia-platform/pull/4) está aberta com os checks de backend e frontend aprovados, aguardando revisão do CTO.
